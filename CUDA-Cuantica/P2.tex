...
Como vimos en ejercicios anteriores, la primera puerta $X$ mapea $|q_0\ra|q_2\ra \mapsto |q_0\ra|q_1 \oplus q_2\ra$. Puesto que inicialmente $|q_2\ra = |0\ra$, tras aplicar la primera puerta obtenemos $|q_0\ra|0\ra \mapsto |q_0\ra|q_0 \oplus 0\ra = |q_0\ra|q_0\ra$. \\
...
De cara al acarreo acumulado en $q_3$, este unicamente es $1$ si ambos qubits son $1$. Por lo tanto, utilizamos la puerta de Toffoli para mapear $|q_0\ra|q_1\ra|0\ra \mapsto |q_0\ra|q_1\ra|0 \oplus (q_0 \wedge q_1)\ra$. \\
